...
function launchMission() {
    ...
    setTimeout(() => {
        startCountdown(launchApproved, rocket, output, consoleBox, flame, risk, reason);
...
function startCountdown(approved, rocket, output, consoleBox, flame, risk, reason) {
...
function startLaunch(rocket, output, flame, risk, reason) {
    ...
    setTimeout(() => {
        ...
        if (ready) {
            ready.textContent = "MISSION COMPLETE";
        }
